		...
		<div class="row">
			<div class="section-heading">
				...
				<div class="list-group">
					<!-- 변경됨 링크를 서블릿으로 바꾸기 -->
					<a href="index.jsp?upkind=417000" class="list-group-item">강아지</a>
					<a href="?upkind=422400" class="list-group-item">고양이</a>
					<a href="?upkind=429900" class="list-group-item">개성동물</a>
					<a href="statistic.puppy"class="list-group-item">검색된 견종리스트</a>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="thumbnail-wrapper">
							<div class="thumbnail">
								...
								<figcaption>
									...
									<h4>
										<a
											href="detail.puppy?popfile=<%out.print(animalList.get(i).getPopfile());%>">
											<%
